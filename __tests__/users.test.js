...
describe("Post /auth/api/signin", () => {
  ...
  it("should return 'user not found.' and status 404.", async () => {
    data.username = "tiagovskiano"  
  ...
  it("should return 'invalid password.', accessToken: null and status 401.", async () => {
    data.username = "tiagovsk"
